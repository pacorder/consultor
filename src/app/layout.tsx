...
export const metadata: Metadata = {
  title: 'SEM Consultores | Sady Enrique Maureria Ferrada',
  description: 'Consultor Senior QA/QC (Calidad) para proyectos y empresas; optimización de procesos, productividad y costos.',
};
